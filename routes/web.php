...
Route::group(['middleware' => ['auth']], function () {
	...
	Route::group(['prefix' => 'carts', 'controller' => CartController::class], function () {
		...
		Route::post('/removeFromCart/{cart}', 'removeFromCart')->name('carts.removeFromCart');
		Route::post('/updateQuantity/{cart}', 'updateQuantity')->name('carts.updateQuantity');
		Route::post('/clearCart', 'clearCart')->name('carts.clearCart');
		Route::get('/getTotal', 'getTotal')->name('carts.getTotal');
	});
